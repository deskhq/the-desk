...
<template>
    ...
    >
        ...
        >
            <!-- `:reserve="false"` because the message is the last thing in the
                 card, with nothing below to spill a wrapped line into (#894), and
                 because the hint gives way to it rather than sitting above it — so
                 one line stands there either way, as drawn, and the primary action
                 does not move out from under the pointer of someone about to press
                 it again. -->
            <FormField
