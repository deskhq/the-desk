...
<!-- Generated by `bin/capture-shell` from the seeded demo workspace, not
captured by hand, and re-checked in CI so it cannot drift from the app. See
CONTRIBUTING.md -> "The product shots". -->
<p align="center">
